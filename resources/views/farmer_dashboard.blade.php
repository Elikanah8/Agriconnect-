            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 mb-6">
                ...
                <form action="{{ route('farmer.products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="mb-4">
                            <input type="number" name="price" placeholder="Price per unit (KES)" step="0.01" class="w-full border-gray-300 rounded-md shadow-sm" required>
                        </div>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4 flex gap-4 items-center">
                        <input type="number" name="quantity" placeholder="Quantity" class="border-gray-300 rounded-md shadow-sm w-1/2" required>
                        <div class="w-1/2">
